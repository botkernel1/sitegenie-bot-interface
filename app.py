...
def get_llm_chain():
    template = """Answer the question based on the context below and use the history of the conversation to continue
                ...
                Context:
                You are deeply knowledgeable about South Africa and you want to suggest the places to visit based on the question.
...
def initialize_session_state():
    if MESSAGES not in st.session_state:
        st.session_state[MESSAGES] = \
            [Message(
                actor=ASSISTANT,
                payload="""Great to hear that you wish to visit South Africa. 
